...
public class JdkCompiler extends AbstractCompiler {
    ...
    public Class<?> doCompile(String name, String sourceCode) throws Throwable {
        ...
        javaFileManager.putFileForInput(StandardLocation.SOURCE_PATH, packageName,
                className + ClassUtil.JAVA_EXTENSION, javaFileObject);
    ...
    private static final class JavaFileObjectImpl extends SimpleJavaFileObject {
        ...
        public JavaFileObjectImpl(final String baseName, final CharSequence source) {
            super(ClassUtil.toURI(baseName + ClassUtil.JAVA_EXTENSION), Kind.SOURCE);
            this.source = source;
        }
    ...
    private final class ClassLoaderImpl extends ClassLoader {
        ...
        public InputStream getResourceAsStream(final String name) {
            if (name.endsWith(ClassUtil.CLASS_EXTENSION)) {
                String qualifiedClassName = name.substring(0, name.length() - ClassUtil.CLASS_EXTENSION.length()).replace('/', '.');
